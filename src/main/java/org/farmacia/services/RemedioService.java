...
public class RemedioService {
    ...
    public static void cadastrarRemedio(Scanner sc) {
        ...
        while (sub == null) {
            try {
                ...
                sub = SubstanciaRepository.encontrarPorNome(subName).get(0);
        ...
        String farmaceuticaNome = sc.nextLine();
        Farmaceutica farm = new Farmaceutica("placeholder", -1, farmaceuticaNome);
        Remedio remedio = new Remedio(sub.meuTipo, sub.nome_substancia, nome, date, quantidade, concentracao, farm);
    ...
    public static void listarRemedios() {
        ...
        if (!remedios.isEmpty()) {
            ...
            System.out.printf("%-12s | %-12s | %-10s %n", "Substância", "Nome", "Vencimento");
            for (Remedio remedio : remedios) {
                System.out.printf("%-12s | %-12s | %-10s %n", remedio.nome_substancia, remedio.nome_remedio, remedio.data_vencimento.format(formatter));
            }
